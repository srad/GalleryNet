...
export const HeartIcon = ({ solid, className = "w-5 h-5" }: { solid?: boolean; className?: string }) => (
    <svg className={className} fill={solid ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
